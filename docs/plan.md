...
| **P1-09** | Errors & resilience | 🟡 **app + route error boundaries done** — recoverable fallback, local-only diagnostics, no document contents logged. **Remaining:** the ten typed domain error classes (`spec.md` §11) and their message map | P1-03 |
